...
#ifndef __RogueDeck__MonsterSelfDamageStatus__
#define __RogueDeck__MonsterSelfDamageStatus__
...
class MonsterSelfDamageStatus : public Status
{
public:
...
#endif /* defined(__RogueDeck__MonsterSelfDamageStatus__) */
