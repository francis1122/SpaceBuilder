...
#ifndef __RogueDeck__LeechLifeTemplate__
#define __RogueDeck__LeechLifeTemplate__
...
class CardSprite;
class LeechLifeTemplate : public CardTemplate
{
    
public:
    static const std::string CLASS_NAME;
    static CardTemplate* create(){ return new LeechLifeTemplate();}
...
#endif /* defined(__RogueDeck__LeechLifeTemplate__) */
