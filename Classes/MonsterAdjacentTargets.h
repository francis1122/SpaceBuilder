...
#ifndef __RogueDeck__MonsterAdjacentTargets__
#define __RogueDeck__MonsterAdjacentTargets__
...
class MonsterAdjacentTargets : public CardTargets
{
public:
...
#endif /* defined(__RogueDeck__MonsterAdjacentTargets__) */
