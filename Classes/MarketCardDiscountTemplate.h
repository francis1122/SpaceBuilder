...
#ifndef __RogueDeck__MarketCardDiscountTemplate__
#define __RogueDeck__MarketCardDiscountTemplate__
...
class CardSprite;
class MarketCardDiscountTemplate : public CardTemplate
{
    
public:
    static const std::string CLASS_NAME;
    static CardTemplate* create(){ return new MarketCardDiscountTemplate();}
...
#endif /* defined(__RogueDeck__MarketCardDiscountTemplate__) */
