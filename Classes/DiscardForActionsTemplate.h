...
#ifndef __RogueDeck__DiscardForActionsTemplate__
#define __RogueDeck__DiscardForActionsTemplate__
...
class CardSprite;
class DiscardForActionsTemplate : public CardTemplate
{
    
public:
    static const std::string CLASS_NAME;
    static CardTemplate* create(){ return new DiscardForActionsTemplate();}
...
#endif /* defined(__RogueDeck__DiscardForActionsTemplate__) */
