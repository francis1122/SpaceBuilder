...
#ifndef __RogueDeck__LeechMonsterLifeStatus__
#define __RogueDeck__LeechMonsterLifeStatus__
...
class LeechMonsterLifeStatus : public Status
{
public:
...
#endif /* defined(__RogueDeck__LeechMonsterLifeStatus__) */
