...
#ifndef __RogueDeck__CardDrawStatus__
#define __RogueDeck__CardDrawStatus__
...
class Player;
class CardSprite;
class CardDrawStatus : public Status
{
public:
    // Here's a difference. Method 'init' in cocos2d-x returns bool, instead of returning 'id' in cocos2d-iphone
    virtual bool initWithCardDraw(int _cardDraw);
    
    int cardDraw;
    
    // implement the "static node()" method manually
    CREATE_FUNC(CardDrawStatus);
...
#endif /* defined(__RogueDeck__CardDrawStatus__) */
